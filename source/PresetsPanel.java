...
class PresetsPanel extends JPanel implements MetricListener, PresetListener
{
	...
	public PresetsPanel(Configuration Configuration)
	{
		...
		setPreferredSize(new Dimension(m_Configuration.getMatrixPadding() + 2 * m_Configuration.getIdentifierFieldWidth(), (StaticConfiguration.getNumberOfPresets() / 2) * (Configuration.getCurrentCellSize() + 1)));
		setMinimumSize(new Dimension(m_Configuration.getMatrixPadding() + 2 * m_Configuration.getIdentifierFieldWidth(), (StaticConfiguration.getNumberOfPresets() / 2) * (Configuration.getCurrentCellSize() + 1)));
	...
	{
		m_Background = createImage(m_Configuration.getIdentifierFieldWidth() + m_Configuration.getMatrixPadding() + m_Configuration.getIdentifierFieldWidth(), 1 + (StaticConfiguration.getNumberOfPresets() / 2) * (Configuration.getCurrentCellSize() + 1));
		
		Graphics OffscreenGraphics = m_Background.getGraphics();
		
		OffscreenGraphics.setColor(m_Configuration.getBackgroundColor());
		OffscreenGraphics.fillRect(0, 0, m_Configuration.getIdentifierFieldWidth() + m_Configuration.getMatrixPadding() + m_Configuration.getIdentifierFieldWidth(), 1 + (StaticConfiguration.getNumberOfPresets() / 2) * (Configuration.getCurrentCellSize() + 1));
	...
	public void paintComponent(Graphics Graphics)
	{
		...
		if(m_Hover != -1)
		{
			...
			{
				Graphics2D.fillRect(m_Configuration.getMatrixPadding() + m_Configuration.getIdentifierFieldWidth(), 1 + (m_Hover - StaticConfiguration.getNumberOfPresets() / 2) * (Configuration.getCurrentCellSize() + 1), m_Configuration.getIdentifierFieldWidth(), Configuration.getCurrentCellSize());
			}
		}
		if(m_Select != -1)
		{
			...
			{
				Graphics2D.fillRect(m_Configuration.getMatrixPadding() + m_Configuration.getIdentifierFieldWidth(), 1 + (m_Select - StaticConfiguration.getNumberOfPresets() / 2) * (Configuration.getCurrentCellSize() + 1), m_Configuration.getIdentifierFieldWidth(), Configuration.getCurrentCellSize());
			}
		}
		...
		Graphics2D.clip(new Rectangle(m_Configuration.getMatrixPadding() + m_Configuration.getIdentifierFieldWidth(), 1, m_Configuration.getIdentifierFieldWidth() - 2, (Configuration.getCurrentCellSize() + 1) * StaticConfiguration.getNumberOfPresets()));
		for(int Name = 0; Name < StaticConfiguration.getNumberOfPresets() / 2; ++Name)
		{
			Graphics2D.drawString(m_Configuration.getPreset(StaticConfiguration.getNumberOfPresets() / 2 + Name).getName(), StaticConfiguration.getNumberFieldWidth() + StaticConfiguration.getNameFieldWidth() + m_Configuration.getMatrixPadding() + StaticConfiguration.getNumberFieldWidth() + Configuration.getCurrentTextOffset(), 1 + (Name + 1) * (Configuration.getCurrentCellSize() + 1) - 3);
		}
